...
const PRODUCTS = [
  ...
  product('three_d_letters', '3D Illuminated Letters', 'signage', 'Custom fabrication', false, ['popular'], 'sign'),
  product('illuminated_sign', 'Illuminated Lightboxes', 'signage', 'Custom fabrication', false, [], 'sign'),
  ...
  product('pylon_sign', 'Pylon & Monolith Signs', 'signage', 'Roadside totem build', false, [], 'sign'),
  ...
  product('corporate_bundle', 'Corporate Identity Suite', 'branding', 'Card + Letterhead + ID + Banner', true, ['popular'], 'card'),
  product('bajaaj_wrap', 'Bajaaj / Rickshaw Wrap', 'branding', 'Full or side wrap', true, ['popular'], 'car'),
  ...
  product('vehicle_wrap', 'Vehicle Wraps', 'branding', 'Full fleet vehicle wrap', false, ['popular'], 'car'),
